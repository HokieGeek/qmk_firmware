...
#define _____BASE_BOTTOM_____  MO(_LOWER),  KC_F13, KC_ENC,   MO(_YABAI),  GUIBSPC,  LALT_T(KC_SPC),       CTLTAB_EXTRAS,  KC_TMUX,  _______,  _______,   KC_SKDM1,  TT(_RAISE)
