 ...
 */
[_EXTRAS] = LAYOUT( \
  _______,  _______, KC_P7,   KC_P8,   KC_P9,   KC_NLCK,      _______, _______, _______, _______, _______, _______, \
  _______,  _______, KC_P4,   KC_P5,   KC_P6,   _______,      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, \
  _______,  _______, KC_P1,   KC_P2,   KC_P3,   KC_P0,        KC_BTN1, KC_BTN3, KC_BTN2, _______, _______, _______, \
  _______,  _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______  \
),
