...
#define _____BASE_BOTTOM_____   MO(_LOWER), _______, _______,  _______, LGUI_T(KC_BSPC), LALT_T(KC_SPC),     TD(td_ctltab_extras),  KC_TMUX, KC_ENC,  TERM_VSCODE,  KC_SKDM1,  MO(_RAISE)
