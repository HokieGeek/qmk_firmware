...
[_QWERTY] = LAYOUT( \
  ...
  KC_SFTENT,    KC_Z,            KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,   KC_DOT,    KC_SLSH, KC_RSFT, \
  SH_TT,        DYN_MACRO_PLAY1, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   TMUX_NEXT, TMUX_PREV, KC_MUTE, SH_TT \
),
