...
#define _____BASE_BOTTOM_____  TT(_LOWER),  DYN_MACRO_PLAY1, SH_TT,   KC_LALT, KC_LGUI,  LT(_CONTROL, KC_SPC),        KC_SPC,  KC_TMUX,  _______,  SH_TT,  _______,  TT(_RAISE)
...
[_RAISE] = LAYOUT( \
  ...
  _______, DYN_REC_START1, _______, _______, _______, _______,      _______, TMUX_PREV, TMUX_PEEK, _______, _______, _______ \
),
