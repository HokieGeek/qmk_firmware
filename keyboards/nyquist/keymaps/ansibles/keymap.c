...
[_BASE] = LAYOUT( \
  ...
  TT(_LOWER),  DYN_MACRO_PLAY1, SH_TT,   KC_LALT, KC_LGUI,  LT(_MOUSE, KC_SPC),    LT(_LIGHTS, KC_SPC),  TMUX_NEXT,  TMUX_PREV,  SH_TT,   KC_MUTE,  TT(_RAISE) \
),
...
[_LOWER] = LAYOUT( \
  ...
  _______,    DYN_REC_STOP,  _______, KC_APP,  _______, _______,      _______,  _______,  _______,  _______,  KC_VOLD,   _______ \
),
...
[_LIGHTS] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______,      BL_STEP, BL_TOGG, RGB_TOG, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, _______  \
),
