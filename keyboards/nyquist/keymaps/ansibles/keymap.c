...
[_BASE] = LAYOUT( \
  ...
  TT(_LOWER),  DYN_MACRO_PLAY1, SH_TT,   KC_LALT, KC_LGUI,  KC_SPC,       LT(_LIGHTS, KC_SPC),  TMUX_NEXT,  TMUX_PREV,  SH_TT,   KC_MUTE,  TT(_RAISE) \
),
...
[_LOWER] = LAYOUT( \
  ...
  QMK_MAKE,   _______,       _______, _______,  _______, _______,      LATIN_N,  _______,  _______,  _______,  LATIN_IQS, _______, \
