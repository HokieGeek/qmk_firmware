...
#define _____QWERTY_R3_____  KC_Z,  KC_X,  KC_C,  KC_V,  LT(_VSCODE, KC_B),  LATIN_N,  KC_M,  KC_COMM, KC_DOT,  LATIN_IQS
...
#define _____COLEMAK_R3_____  KC_Z, KC_X,  KC_C,  KC_V,  LT(_VSCODE, KC_B),  KC_K,  KC_M,  KC_COMM, KC_DOT,  LATIN_IQS
